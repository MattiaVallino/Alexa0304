...
module.exports = {
    ...
    async setTherapy(therapy){
      ...
      let end_date_w
     console.log('start1' + start_date_w.format('YYYY-MM-DDTHH:mm:ss'))    
       console.log('end1 ' +therapy.end_date)
     if (!therapy.end_date || !therapy.end_date===undefined) {
                    ...
                    end_date_w = end_date_w.add(1,'year')
                    console.log(end_date_w.format('YYYY-MM-DDTHH:mm:ss'))
        }else{
             end_date_w = moment(therapy.end_date).tz(timezone)    
        }
     

        console.log('end date2' +end_date_w.format('YYYY-MM-DDTHH:mm:ss'))
      console.log('start2 '   + start_date_w.format('YYYY-MM-DDTHH:mm:ss'))
